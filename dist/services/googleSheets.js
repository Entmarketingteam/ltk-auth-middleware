...
exports.appendToGoogleSheets = appendToGoogleSheets;
exports.createAnalyticsSheet = createAnalyticsSheet;
 ...
 */
async function appendToGoogleSheets(data, config) {
    try {
 ...
 */
async function createAnalyticsSheet(title, credentials) {
    try {
        const config = {
 ...
 */
async function getSheetData(config, range) {
    try {
        const sheets = await getSheetsClient(config);
        const sheetName = config.sheetName || 'Analytics Data';
