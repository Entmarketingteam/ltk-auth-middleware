...
exports.loginToMavely = loginToMavely;
exports.validateMavelyTokens = validateMavelyTokens;
 ...
 */
async function loginToMavely(email, password, options = {}) {
    ...
    try {
        ...
        if (!accessToken) {
            ...
            const relevantCookie = authCookies.find(c => c.name.toLowerCase().includes('session') ||
 ...
 */
async function validateMavelyTokens(accessToken) {
    try {
...
//# sourceMappingURL=mavelyLogin.js.map